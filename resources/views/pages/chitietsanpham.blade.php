        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                ...
                <div class="mb-2 specifi">
                    <ul>
                        <li class="specifi">
                            <i class="fa fa-thumbs-o-up"></i>Bộ sản phẩm gồm:
                            <em class="text-primary">Hộp, Sạc, Tai nghe, Sách hướng dẫn, Cáp, Cây lấy sim, Ốp lưng</em>
                        </li>
                        <li class="specifi"><i class="fa fa-thumbs-o-up"></i>Bảo hành chính hãng 12 tháng</li>
                        <li class="specifi"><i class="fa fa-thumbs-o-up"></i>Lỗi là đổi mới trong 1 tháng trên toàn bộ cửa hàng</li>
                    </ul>
                </div>
                ...
                <div class="border mb-2">
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <tr>
                                <td>Camera sau</td>
                                <td>{{$specefi->camera_affter}}</td>
                            </tr>
                            <tr>
                                <td>Camera trước</td>
                                <td>{{$specefi->camera_pre}}</td>
                            </tr>
                            <tr>
                                <td>CPU</td>
                                <td>{{$specefi->cpu}}</td>
